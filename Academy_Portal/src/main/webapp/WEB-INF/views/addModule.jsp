...
<ul class="nav navbar-nav">
    ...
    <li><a href="addModule.html" class="btn btn-danger navbar-btn nevButton1">Add Module</a></li>
            ...
            <h2>Module Registration</h2>
             <form id="login-form" action="addModule.html" method="post" role="form" style="display: block;">
                  ...
                  <div class="form-group">
                    <input type="text" autocomplete="off" name="moduleId" id="moduleId" tabindex="1" class="form-control" placeholder="Module Id" value="" required>
                  </div>
                  <div class="form-group">
                    <input type="text" autocomplete="off" name="moduleName" id="moduleName" tabindex="1" class="form-control" placeholder="Module Name" value="" required>
                  </div>
                  <div class="form-group">
                    <input type="text" autocomplete="off" name="moduleDesc" id="moduleDesc" tabindex="2" class="form-control" placeholder="Module Description" required>
                  </div>
                  <div class="form-group">
                    <div class="row">
