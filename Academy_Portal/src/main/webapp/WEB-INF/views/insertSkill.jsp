...
<ul class="nav navbar-nav">
    ...
    <li><a href="insertSkill.html" class="btn btn-danger navbar-btn nevButton1">Insert Skill</a></li>
</ul>
  </div>
</nav>
            ...
            <h2>Skill Form <a href="logout.html" class="form-control btn logout">Logout </a> </h2>
             <form id="login-form" action="insertSkill.html" method="post" role="form" style="display: block;">
                  ...
                  <div class="form-group">
                    <input type="text" autocomplete="off" name="skillId" id="skillId" tabindex="1" class="form-control" placeholder="Enter SkillId" value="" required>
                  </div>
                  <div class="form-group">
                    <input type="text" autocomplete="off" name="skill" id="skill" tabindex="1" class="form-control" placeholder="Enter Skill" value="" required>
                  </div>
                  <div class="form-group">
                    <input type="text" autocomplete="off"  name="certification" id="certification" tabindex="2" class="form-control"  placeholder="Enter Certification" required>
                  </div>
                  <div class="form-group">
                    <div class="row">
