...
<ul class="nav navbar-nav">
    ...
    <li><a href="generateReport.html" class="btn btn-danger navbar-btn nevButton1">Generate Report</a></li>
...
<%-- <div class="container">
        ...
        <div class="panel-body">
          <div class="row">
            ...
            <h2>Generate Report <a href="logout.html" class="form-control btn logout">Logout </a> </h2>
             <form id="login-form" name="generate_form" action="generateReport.html" method="post" role="form" style="display: block;">
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-sm-6 col-sm-offset-3">
                        <input type="submit" name="register-submit" id="generate" tabindex="4" class="form-control btn btn-register" value="Generate"><br><br>
                      	<input type="reset" name="register-submit" id="reset" tabindex="4" class="form-control btn btn-register" value="Reset">
           			 </div>
                    </div>
                  </div>
              </form>
 ...
 var x = document.forms["generate_form"]["batchId"].value;
