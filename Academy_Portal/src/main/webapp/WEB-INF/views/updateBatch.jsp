...
<title>Update Batch Allocation</title>
...
<ul class="nav navbar-nav">
    ...
    <li><a href="updateBatch.html" class="btn btn-danger navbar-btn nevButton1">update Batch</a></li>
...
<%-- <div class="container">
        ...
        <div class="panel-body">
          <div class="row">
            ...
            <h2>Update Batch Allocation <a href="logout.html" class="form-control btn logout">Logout </a> </h2>
             <form id="login-form" action="updateBatch.html" name="updateBatchAllocation" method="post" role="form" style="display: block;">
               	<div class="form-group">
               	<br>
               	
    				<select name="batchAllocationId">
                          <option value="batchId">Batch Allocation Id
                          </option>
                  ...
                  <div class="form-group">
                    <input type="text" autocomplete="off" name="closeDate" id="closeDate" tabindex="2" class="form-control" placeholder="Closing Date" value="" required>
                  </div>
 ...
 var x = document.forms["updateBatchAllocation"]["batchAllocationId"].value;
 
  if (x == "batchId") {
    alert("Please Select Batch Allocation ID");
    return false;
  }
});
          //# sourceURL=pen.js
