...
<ul class="nav navbar-nav all">
    <li></li>
    <li><a href="registerUser.html" class="btn btn-danger navbar-btn nevButton1">Register New User</a></li>
    ...
    <li><a href="insertBatch.html" class="btn btn-danger navbar-btn nevButton">Insert Batch</a></li>
      ...
      <div class="panel panel-login">
        <div class="panel-body">
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
           <h2>REGISTER</h2> 
             <form id="login-form" action="registerUser.html" method="post" role="form" style="display: block;" enctype="multipart/form-data">
             
                  <div class="form-group">
                    <input type="text" autocomplete="off" name="userName" id="username" tabindex="1" class="form-control" placeholder="Username" value="" required>
                  </div>
                   <div class="form-group">
                    <input type="text" autocomplete="off" name="fName" id="fName" tabindex="1" class="form-control" placeholder="First Name" value="" required>
                  </div>
                  <div class="form-group">
                    <input type="text" autocomplete="off" name="lName" id="lName" tabindex="1" class="form-control" placeholder="Last Name" value="" required>
                  </div>
                  <div class="form-group">
                  <table >
                  <tr>
                  <td width="90%">
                    <input type="password" name="password" id="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"  tabindex="1" class="form-control" placeholder="Password" value="" required>
                    </td >
                    <td width="10%" align="center">
                    <div class="help" id="help" title="Requaired format"><img alt="" src="https://firebasestorage.googleapis.com/v0/b/grizzly-5a659.appspot.com/o/36601.png?alt=media&token=925db137-c3d5-4532-af35-4f0a4d6b57fa" width="10px"></div>
                 </td>
                 </tr>
                 <tr><input type="file" name="profile_photo" id="profile_photo" class="form-control" placeholder="Profile Picture" required>
                 </tr>  
                 </table>
                  </div>
