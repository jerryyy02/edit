...
<ul class="nav navbar-nav">
    ...
    <li><a href="batchAllocation.html" class="btn btn-danger navbar-btn nevButton1">Batch Allocation</a></li>
        ...
        <div class="panel-body">
          <div class="row">
            ...
            <h2>Batch Allocation</h2>
             <form id="login-form" action="batchAllocation.html" name="allocationForm" method="post" role="form" style="display: block;">
                  ...
                  <div class="form-group"> 
                    <input type="text" autocomplete="off" name="startDate" id="startDate" tabindex="2" class="form-control" placeholder="Start Date" value="" required>
                  </div>
                  <div class="form-group">
                    <input type="text" autocomplete="off" name="endDate" id="endDate" tabindex="3" class="form-control" placeholder="End Date" value="" required>
                  </div>
                 
                  <div class="form-group">
                    <div class="row">
                      <div class="col-sm-6 col-sm-offset-3">
                        <input type="submit" name="register-submit" id="allocateBatch" tabindex="4" class="form-control btn btn-register" value="Allocate">
                      </div>
                    </div>
                  </div>
              </form>
...
<script>
         ...
         $("#allocateBatch").click(function (event) {
 // event.preventDefault(); 
 var x = document.forms["allocationForm"]["batchId"].value;
 var y = document.forms["allocationForm"]["facultyId"].value;
 var z = document.forms["allocationForm"]["module"].value;
  if (x == "batch") {
    alert("Please Select Batch,Faculty and Module");
    return false;
  }
  if (y=="faculty") {
	    alert("Please Select Batch,Faculty and Module");
